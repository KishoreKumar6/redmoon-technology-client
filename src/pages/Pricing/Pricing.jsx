...
const plans = [
  ...
  },
  {
    ...
    features: ['15-page custom website', 'Premium UI/UX design', 'Full SEO setup', 'Blog & CMS', 'Admin dashboard', 'E-Commerce store', 'Email integration', '3 months support', 'Performance optimized', 'Analytics & heatmaps', 'Social media integration'],
...
const comparison = [
  ...
  { feature: 'E-Commerce', starter: false, pro: true, enterprise: true },
